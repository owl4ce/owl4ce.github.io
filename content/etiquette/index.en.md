...
**Cras**<b style='color:#fa74b2'>.</b> (`/kraːs/`), in Latin means **Morrow**<b style='color:#fa74b2'>.</b> in archaic style, is a web-book created to publish various authentic literary works written by the respective author(s). Since authentic(-unique) literary works were semi-open licensed, i.e. conditional reproduction of copies is permitted. It is highly prohibited to arbitrarily use (or copy) the same sentences precisely without following the terms, as stated at the footer of the page. Contact (or critique) alternate-se<span style='color:#cf8ef4'>7</span>en(at)crdinusc.eu.org.
